...
\begin {figure}
	\centering
	\subfigure [] { \includegraphics [width=0.12\columnwidth] {figures/winding1} \label{fig:wind_a}}
	\hspace{0.5cm}
	\subfigure [] { \includegraphics [width=0.12\columnwidth] {figures/winding2} \label{fig:wind_b}}
	\hspace{0.5cm}
	\subfigure [] { \includegraphics [width=0.12\columnwidth] {figures/fill_rule_even_odd_1} \label{fig:wind_c}}
	\hspace{0.5cm}
	\subfigure [] { \includegraphics [width=0.12\columnwidth] {figures/fill_rule_non_zero_1} \label{fig:wind_d}}
	\hspace{0.5cm}
	\subfigure [] { \includegraphics [width=0.12\columnwidth] {figures/fill_rule_any_2} \label{fig:wind_e}}
	\caption
