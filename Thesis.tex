...
\begin {figure}
	\centering
	\subfigure[Vector image]{\includegraphics[width=0.40\columnwidth] {figures/zoom_vector} \label{fig:zoom_vector}}
	\hspace{1.0cm}
	\subfigure[Raster image]{\includegraphics[width=0.35\columnwidth] {figures/zoom_raster} \label{fig:zoom_raster}}
